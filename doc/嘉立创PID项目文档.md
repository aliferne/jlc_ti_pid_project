...
TODO: 这两个按键（一个是中间的按键，另外一个是摇杆的z轴按键）的功能是相同的，目前并没有想好具体要让它们做什么
...
5. 大大小小的优化，官方的案例存在较多魔法数字和“Repeat Yourself”（尤其是在ui绘制中），因此我针对出现频率较高的，都单独抽象成了函数或者宏的表现形式，然后再去调用，由于改动较多，就不放出代码了。
